...
require (
	...
	github.com/spanarek/dia/pkg/webhook/basic v0.0.0-00010101000000-000000000000
	github.com/spanarek/dia/pkg/webhook/verify v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/k8schain v0.0.0-20210521160948-0233fcda5d53 // indirect
...
replace (
	github.com/spanarek/dia/pkg/webhook/basic => ./pkg/webhook/basic
	github.com/spanarek/dia/pkg/webhook/verify => ./pkg/webhook/verify
)
